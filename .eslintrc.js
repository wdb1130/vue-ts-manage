module.exports = {
  ...
  rules: {
    ...
    "vue/name-property-casing": ["error", "Pascal Case"],
    "vue/no-v-html": "off",
    ...
    'no-self-assign': 2,  //禁止在正则表达式字面量中使用多个空格 /foo bar/
    ...
    'no-unmodified-loop-condition': 2,  // 循环中的变量经常在循环中修改。
    ...
    'space-before-blocks': [2, 'always'], //{前面要不要有空格
